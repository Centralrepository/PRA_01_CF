...
public class SendAttachmentInEmail {
   public void sendEmail(String fromemail, String toemail, String subject, String body, String filepath) {
      ...
      String text = "<p>You have recieved this mail, Because you have Subscrided to QuickDaan NEWSLETTER click here to</p>";
    		  ...
    		  String redirectURL = "http://127.0.0.1:8080/web/bindu/news-letter-unsubscribe?email="+to+"";
